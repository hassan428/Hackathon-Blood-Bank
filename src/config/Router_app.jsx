...
import { setHitDatabase, setLoginSuccess, setUserID } from "../store/slices/userLoggedSlice";
          ...
          if (Object.keys(myData).length === 0) {
            ...
            const otherUserData = dataArr.filter((v) => {
              ...
              if (v.uid !== uid) {
                ...
                if ((myData.bloodGroup == "A+" || myData.bloodGroup == "B+" || myData.bloodGroup == "AB+") && v?.bloodGroup == "AB+") {
                  return v
                }
